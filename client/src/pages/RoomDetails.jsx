    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
          ...
          <div className='flex flex-col'>
            ...
            <input onChange={(e) => setGuests(e.target.value)}
              value={guests} type="number" id='guests' placeholder='1'
      ...
      <div className='flex flex-col items-start gap-4'>
        <div className='flex gap-4'>
          {/* ✅ Fixed: fallback image agar database mein via.placeholder.com ho */}
          <img src={room?.hotel?.owner?.image || "https://placehold.co/150"}
            alt="Host" className='h-14 w-14 md:h-18 md:w-18 rounded-full' />
          <div>
